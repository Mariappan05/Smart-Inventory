        ...
        <div className="flex items-center justify-between">
          ...
          {isAdmin && (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-black px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-900 dark:bg-slate-950 dark:hover:bg-black"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 rounded-2xl bg-black px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-900 disabled:opacity-50 dark:bg-slate-950 dark:hover:bg-black"
                >
                  {loading ? (
