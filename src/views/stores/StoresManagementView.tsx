          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-slate-800">
                ...
                <th className="px-6 py-3 text-center text-sm font-semibold text-slate-900 dark:text-slate-100">Users</th>
                <th className="px-6 py-3 text-center text-sm font-semibold text-slate-900 dark:text-slate-100">Products</th>
            ...
            <tbody>
              {stores.map((store) => (
                ...
                >
                  <td className="px-6 py-4 text-sm font-medium text-slate-900 dark:text-slate-100">{store.code}</td>
                  <td className="px-6 py-4 text-sm text-slate-700 dark:text-slate-300">{store.name}</td>
                      ...
                      {userRole && ["ADMIN", "STORE_MANAGER"].includes(userRole) && (
                        <>
                          <button
                            ...
                            className="p-2 text-slate-600 hover:bg-slate-100 rounded transition-colors dark:text-slate-400 dark:hover:bg-slate-700"
                            title="Edit store"
                          >
